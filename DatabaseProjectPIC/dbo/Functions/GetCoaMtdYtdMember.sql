...
-- =============================================
CREATE FUNCTION [dbo].[GetCoaMtdYtdMember] 
(	
...
(
	...
	Where MemberId=@MemberId and MonthEffCoaDate=Month(getDate()) and YearEffCoaDate=Year(getDate())), 

	CoaYear as (Select Count(*)  [Year] from CoaHistory
	Where MemberId=@MemberId and  YearEffCoaDate=Year(getDate())), 
